...
- **Ресурсы и спрайты**: спрайты оформляются в формате RSI (`.rsi`). Формат DMI из BYOND не используется. Лицензии сторонних материалов обязательно указываются в метаданных файлов.
