...
- **Ресурсы и спрайты**: спрайты оформляются в формате **RSI** (`.rsi`) — это формат SS14, не BYOND DMI. Лицензии сторонних материалов обязательно указываются в метаданных файлов.
