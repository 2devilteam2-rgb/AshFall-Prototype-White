...
public sealed partial class UseRequiresSightSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<UseRequiresSightComponent, GettingUsedAttemptEvent>(OnUseAttempt);
    }

    private void OnUseAttempt(Entity<UseRequiresSightComponent> ent, ref GettingUsedAttemptEvent args)
    {
        var user = args.User;
