...
public sealed partial class MouseRotatorComponent : Component
{
    ...
    public Angle AngleTolerance = Angle.FromDegrees(2.5);   // AshFall-Tweak: 20 -> 2.5
    ...
    /// </summary>
    [DataField, AutoNetworkedField]
    public double RotationSpeed = 540f;  // AshFall-Tweak: float.MaxValue -> 540f
    ...
    /// </summary>
    [DataField, AutoNetworkedField]
    public bool Simple4DirMode = false; // AshFall-Tweak: true -> false
}
